<?php 
    ...
    $name = htmlspecialchars($_SESSION['all']['name']);
    $mail = htmlspecialchars($_SESSION['all']['mail']);
    $password = htmlspecialchars($_SESSION['all']['password']);
    $photo = $_SESSION['all']['photo'];
    ...
    if (!empty($_POST)) {
        ...
        $data = array($name, $mail, sha1($password), $photo);
            ...
            <table class="table table-striped table-condensed">
              <tbody>
                ...
                <tr>
                  ...
                  <td><div class="text-center"><img src="../photos/<?php echo $photo; ?>" width="100" height="100"></div></td>
                </tr>
              </tbody>
            </table>
