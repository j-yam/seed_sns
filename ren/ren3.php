<?php 
   ...
   if (!empty($_POST)) {
         ...
         }  elseif (mb_stren($_POST['password']) < 4) {
      ...
      if (!isset($error)) {
          ...
          if ($email_count['count'] >= 1) {
              ...
              if ($ext == 'jpg' || $ext == 'png' || $ext = 'gif') {
                  $photo_name = $_FILES['picture_path']['name'];
                  move_uploaded_file($_FILES['picture_path']['tmp_name'], '../photos_name/ . $photo_name');
                  $_SESSION['join'] = $_POST;
        ...
        <form method="POST" action="" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <?php } elseif (isset($error['email']) && $error['email'] == 'blank') { ?>
